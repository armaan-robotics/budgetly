    ...
    <>
      ...
      <div style={{minHeight:"100vh",background:C.bg,display:"flex"}}>
        ...
        <main className="main-wrap" style={{flex:1,padding:"36px 32px",overflowX:"hidden",overflowY:"auto",minWidth:0}}
          ...
          <div className="main-content-inner" style={{transform:`translateX(${swipeOffset}px)`,transition:swipeOffset===0?"transform 0.3s cubic-bezier(0.25,0.46,0.45,0.94)":"none",animation:swipeAnim==="in-left"?"slideInFromRight 0.32s cubic-bezier(0.25,0.46,0.45,0.94)":swipeAnim==="in-right"?"slideInFromLeft 0.32s cubic-bezier(0.25,0.46,0.45,0.94)":"none",willChange:"transform",overflowX:"hidden",overflowY:"auto",maxWidth:"100%",height:"100%"}}>
